...
import com.spydroid.net.rtsp.RtspConstants.VideoEncoder;
...
import com.spydroid.net.rtsp.client.message.RtspDescriptor;
import com.spydroid.net.rtsp.client.message.RtspMedia;
import com.spydroid.net.rtsp.client.transport.TCPTransport;
