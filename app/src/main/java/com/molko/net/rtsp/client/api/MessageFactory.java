package com.molko.net.rtsp.client.api;
/**
...
public interface MessageFactory {
	...
	public Request outgoingRequest(String uri, Request.Method method, int cseq, String txt, RtspHeader... extras) throws URISyntaxException;
