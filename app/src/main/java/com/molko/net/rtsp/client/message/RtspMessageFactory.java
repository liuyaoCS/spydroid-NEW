package com.molko.net.rtsp.client.message;
/**
...
import com. molko.net.rtsp.client.api.Message;
import com. molko.net.rtsp.client.api.MessageFactory;
import com. molko.net.rtsp.client.api.Response;
import com. molko.net.rtsp.client.api.Request.Method;
import com. molko.net.rtsp.client.header.CSeqHeader;
import com. molko.net.rtsp.client.header.ContentEncodingHeader;
import com. molko.net.rtsp.client.header.ContentLengthHeader;
import com. molko.net.rtsp.client.header.ContentTypeHeader;
import com. molko.net.rtsp.client.header.RtspContent;
import com. molko.net.rtsp.client.header.RtspHeader;
import com. molko.net.rtsp.client.header.SessionHeader;
import com. molko.net.rtsp.client.header.TransportHeader;
import com. molko.net.rtsp.client.request.RtspAnnounceRequest;
import com. molko.net.rtsp.client.request.RtspDescribeRequest;
import com. molko.net.rtsp.client.request.RtspOptionsRequest;
import com. molko.net.rtsp.client.request.RtspPauseRequest;
import com. molko.net.rtsp.client.request.RtspPlayRequest;
import com. molko.net.rtsp.client.request.RtspRequest;
import com. molko.net.rtsp.client.request.RtspSetupRequest;
import com. molko.net.rtsp.client.request.RtspTeardownRequest;
import com. molko.net.rtsp.client.response.RtspResponse;
...
public class RtspMessageFactory implements MessageFactory {
	...
	static {
		...
		try {
			...
			requestMap.put(RtspRequest.Method.ANNOUNCE, RtspAnnounceRequest.class);
	...
	public RtspRequest outgoingRequest(String uri, RtspRequest.Method method, int cseq, String body, RtspHeader... extras) throws URISyntaxException {
		RtspRequest message = outgoingRequest(uri, method, cseq, extras);
		message.addLine(body);
		return message;
